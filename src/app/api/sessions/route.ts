import { CheckSessionToken, GetAllActiveSessions, GetSessionInfo } from "@/backend/helper/SessionHelper";
...
export async function POST(req: NextRequest) {
    ...
    return NextResponse.json({ success: true, sessions: await GetAllActiveSessions() });
}